...
pub fn next(self: *Tokenizer) Token {
    ...
    while (self.index < self.buf.len) : (self.index += codepoint_len) {
        ...
        switch (state) {
            ...
            .integer_suffix_ui => switch (c) {
                'l', 'L' => state = .integer_suffix_uli,
                    ...
                    id = .imaginary_integer_literal_u;
                    break;
                },
            },
            ...
            .integer_suffix_li => switch (c) {
                ...
                'u', 'U' => state = .integer_suffix_uli,
                    ...
                    id = .imaginary_integer_literal_l;
                    break;
                },
            },
            ...
            .integer_suffix_lli => switch (c) {
                'u', 'U' => {
                    id = .imaginary_integer_literal_llu;
                    self.index += 1;
                    break;
                },
                else => {
                    id = .imaginary_integer_literal_ll;
                    break;
                },
            },
            ...
            .integer_suffix_uli => switch (c) {
                'l', 'L' => {
                    ...
                    id = .imaginary_integer_literal_lu;
                    break;
                },
            },
        ...
        switch (state) {
            ...
            .integer_suffix_i => id = .imaginary_integer_literal,
            .integer_suffix_ui => id = .imaginary_integer_literal_u,
            .integer_suffix_li => id = .imaginary_integer_literal_l,
            .integer_suffix_lli => id = .imaginary_integer_literal_ll,
            .integer_suffix_uli => id = .imaginary_integer_literal_lu,
